...
def test_template_engine_conditionals():
    ...
    # With link
    result_with_link = engine.render(recipient="john@example.com", link="https://example.com")
...
def test_template_engine_else():
    ...
    # With premium
    result = engine.render(recipient="john@example.com", extra_placeholders={"premium": "true"})
...
def test_template_validation():
    ...
    engine = TemplateEngine(html_content="Hello {{first_name}}, your {{custom_var}} is ready")
...
def test_get_used_placeholders():
    ...
    engine = TemplateEngine(html_content="{{email}} {{first_name}} {{company}}")
