...
def test_generate_qr(logged_in_client):
    ...
    response = logged_in_client.post("/tools/qr", data={"data": "https://example.com"})
...
def test_render_content_pdf(logged_in_client):
    ...
    response = logged_in_client.post("/tools/render", data={"content": html, "format": "pdf"})
...
def test_render_content_image(logged_in_client):
    ...
    response = logged_in_client.post("/tools/render", data={"content": html, "format": "image"})
...
def test_render_content_missing_content(logged_in_client):
    ...
    response = logged_in_client.post("/tools/render", data={"format": "pdf"})
