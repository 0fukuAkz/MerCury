...
class WebhookService:
    ...
    async def notify(
        ...
        webhooks = [
            ...
            if w.enabled and (not w.events or event in w.events)
        ]
    ...
    async def notify_email_sent(
        ...
        return await self.notify(WebhookEvent.EMAIL_SENT, {
            'recipient': recipient,
            'subject': subject,
    ...
    async def notify_email_failed(
        ...
        return await self.notify(WebhookEvent.EMAIL_FAILED, {
            'recipient': recipient,
            'error': error,
    ...
    async def notify_email_bounced(
        ...
        return await self.notify(WebhookEvent.EMAIL_BOUNCED, {
            'recipient': recipient,
    ...
    async def notify_campaign_started(
        ...
        return await self.notify(WebhookEvent.CAMPAIGN_STARTED, {
    ...
    async def notify_campaign_completed(
        ...
        return await self.notify(WebhookEvent.CAMPAIGN_COMPLETED, {
            'campaign_id': campaign_id,
            'campaign_name': campaign_name,
            'total': total,
            'success': success,
