...
class BounceService:
    ...
    def categorize_bounce(
        self, smtp_code: Optional[str], error_message: str
    ...
    def process_complaint(self, email: str, campaign_id: Optional[str] = None) -> BounceRecord:
        """
    ...
    def process_unsubscribe(self, email: str, campaign_id: Optional[str] = None) -> BounceRecord:
        """
