        ...
        *live values* for a specific recipient on a specific send. This
        ...
        return [
            ...
            },
            {
                "name": "local_part",
                "category": "Recipient",
                "description": "Part of email before the @.",
                "sample": "alice",
            },
            {
                "name": "username",
            ...
            },
            {
                "name": "domain",
                "category": "Recipient",
                "description": "Full email domain (with TLD).",
                "sample": "acme.com",
            },
            {
                "name": "domain_name",
                "category": "Recipient",
                "description": "Email domain without the TLD.",
                "sample": "acme",
            },
            {
                "name": "tld",
                "category": "Recipient",
                "description": "Top-level domain of the email.",
                "sample": "com",
            },
            # ── Render-time extras (engine appends these per-send) ────
            {
                ...
                "description": "Campaign primary_link (or rotated link).",
