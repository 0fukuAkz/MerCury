...
def hash_password(password: str, salt: Optional[bytes] = None) -> str:
    ...
    hash_bytes = hashlib.pbkdf2_hmac("sha256", password.encode(), salt, iterations=480000)
...
def verify_password(password: str, password_hash: str) -> bool:
    ...
    try:
        ...
        computed_hash = hashlib.pbkdf2_hmac("sha256", password.encode(), salt, iterations=480000)
...
def validate_unsubscribe_token(
    token: str, email_id: str, email: Optional[str] = None
) -> Tuple[bool, str]:
    """
