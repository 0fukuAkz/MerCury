...
def validate_email(
    email: str, check_deliverability: bool = False, allow_smtputf8: bool = True
    ...
    if not email:
        return EmailValidationResult(email=email, is_valid=False, error="Empty email address")

    try:
        result = _validate_email(
            email, check_deliverability=check_deliverability, allow_smtputf8=allow_smtputf8
        )
        ...
        return EmailValidationResult(email=email, is_valid=False, error=str(e))


def validate_emails_batch(
    emails: List[str], check_deliverability: bool = False, deduplicate: bool = True
